...
seriosness = practicality / time

humbleness = fun / seriousness
marginalism = seriosness / fun
...
maximum_black = very_best * 85000000 # large jump; increasing factor is set intuitively 


### 3.2 Outputs

print('\n >> maximum_black: ',maximum_black)
